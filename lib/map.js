const petition = window.location.search.slice(1).trim() || "241584";
const petition_data_url = `https://petition.parliament.uk/petitions/${petition}.json`;

// state
const state = { hexjson: null, petition: null };
...
const renderMessage = function(petition) {
  // message
...
const saveState = function([hexjson_resp, petition_resp]) {
